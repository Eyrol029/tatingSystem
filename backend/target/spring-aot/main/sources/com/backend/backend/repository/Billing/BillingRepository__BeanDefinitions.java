...
/**
 * Bean definitions for {@link BillingRepository}.
 */
@Generated
public class BillingRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'billingRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getBillingRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'billingRepository'.
   */
  public static BeanDefinition getBillingRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, BillingRepository.class, Billing.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.backend.backend.repository.Billing.BillingRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.BillingRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.backend.backend.repository.Billing.BillingRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getBillingRepositoryInstanceSupplier();
