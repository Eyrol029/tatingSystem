...
/**
 * Bean definitions for {@link SpouseRepository}.
 */
@Generated
public class SpouseRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'spouseRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getSpouseRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'spouseRepository'.
   */
  public static BeanDefinition getSpouseRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, SpouseRepository.class, Spouse.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.backend.backend.repository.FamilyPlanning.SpouseRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.SpouseRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.backend.backend.repository.FamilyPlanning.SpouseRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getSpouseRepositoryInstanceSupplier();
