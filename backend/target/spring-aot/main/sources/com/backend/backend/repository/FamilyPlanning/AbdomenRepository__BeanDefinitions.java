...
/**
 * Bean definitions for {@link AbdomenRepository}.
 */
@Generated
public class AbdomenRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'abdomenRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getAbdomenRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'abdomenRepository'.
   */
  public static BeanDefinition getAbdomenRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, AbdomenRepository.class, Abdomen.class, Integer.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.backend.backend.repository.FamilyPlanning.AbdomenRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.AbdomenRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.backend.backend.repository.FamilyPlanning.AbdomenRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getAbdomenRepositoryInstanceSupplier();
