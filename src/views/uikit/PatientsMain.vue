                ...
                <div class="p-6 space-y-6">
                    ...
                    <div class="flex flex-wrap gap-3">
                        ...
                        <button @click="printReport" :disabled="!reportData"
                            class="border border-purple-300 text-purple-700 bg-white hover:bg-purple-50 px-4 py-2 rounded-md text-sm font-medium shadow-sm transition disabled:opacity-50">
                            Print Report
                        </button>
                    </div>
