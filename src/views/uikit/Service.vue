        ...
        <div v-if="view === 'add' || view === 'edit'" class="max-w-2xl">
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <form @submit.prevent="view === 'add' ? handleAddService() : handleEditService()" class="space-y-4">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-1">Base Case Number Format</label>
                        <p class="text-xs text-gray-500 mb-2">Patient IDs will start from this base format and increment sequentially (e.g., 26-00-000 -> 26-00-001)</p>
                        <input
                            v-model="formData.caseNumber"
                            type="text"
                            placeholder="e.g., 26-00-000"
