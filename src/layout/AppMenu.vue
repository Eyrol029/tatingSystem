...
const model = [
    ...
    },
    {
        items: [
            ...
            { label: 'Revenue', icon: 'pi pi-fw pi-chart-bar', to: '/uikit/Revenue', roles: [UserRole.ADMIN] },
            { label: 'Statement of Account', icon: 'pi pi-fw pi-file', to: '/uikit/SOA', roles: [UserRole.ADMIN, UserRole.MIDWIFE] },
