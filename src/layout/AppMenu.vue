...
const model = [
    ...
    },
    {
        items: [
            ...
            { label: 'Patients', icon: '', to: '/uikit/PatientsMain', roles: [UserRole.ADMIN] },
            ...
            {label: 'SOA', icon: '', to: '/uikit/viewListOfSOA', roles: [UserRole.ADMIN] },
            ...
            { label: 'Enquiries', icon: '', to: '/uikit/Logs', roles: [UserRole.ADMIN] },
            { label: 'User Account', icon: '', to: '/uikit/UserAccount', roles: [UserRole.ADMIN] },
            { label: 'Employee', icon: '', to: '/uikit/Staff', roles: [UserRole.ADMIN,] },
